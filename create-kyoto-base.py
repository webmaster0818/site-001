...
KYOTO_WARDS = [
    {
        ...
        "name": "中央区",
        "reading": "ちゅうおう-く",
        "intro": "中央区は京都市の中心部に位置し、京都駅・大通・すすきのがある京都の中心街です。商業施設が集積し、観光地も多いエリアです。",
        "areas": ["京都駅前", "大通", "すすきの", "円山", "宮の森", "中島公園"],
        "point1_title": "京都駅・大通など中心街、都市汚れ・排気ガス対策重要",
        "point1_text": """中央区は京都駅・大通・すすきのなど京都市の中心街で、人通り・車通りが非常に多いエリアです。
都心部のため、排気ガスや都市汚れが窓ガラスやエアコンに付着しやすい環境です。
特に幹線道路沿いや駅周辺では、排気ガスや粉塵などの汚れが蓄積しやすくなります。
定期的な窓清掃（年2回）とエアコンクリーニング（年1回）で、快適な室内環境を保つことが重要です。""",
        "point2_title": "豪雪地帯、冬季の暖房汚れ・結露対策重要",
        "point2_text": """中央区は豪雪地帯で、冬季（11-3月）は暖房を長時間使用するため、室内汚れが蓄積しやすい環境です。
暖房によるエアコン内部の汚れや、窓ガラスの結露によるカビの発生に注意が必要です。
特に冬季は換気が不十分になりがちで、室内の空気が汚れやすくなります。
春先（4-5月）のエアコンクリーニングと窓清掃で、冬季の汚れをリセットすることが重要です。""",
        "point3_title": "JR・地下鉄・市電など交通非常に良好、業者の選択肢が非常に豊富",
        "point3_text": """中央区はJR函館本線、地下鉄南北線・東西線・東豊線、市電など複数の鉄道路線が通っており、交通の便が非常に良好です。
京都駅、大通駅、すすきの駅など主要駅が多数あり、京都市内各地からアクセスしやすいエリアです。
...
即日対応可能な業者も多数あり、複数社を比較することで、最適な業者を見つけやすい環境といえます。""",
    },
    {
        ...
        "name": "北区",
        "reading": "きた-く",
        "intro": "北区は京都市の北部に位置し、京都府大学がある文教地区として知られています。学生街と住宅地が混在しています。",
        "areas": ["北大前", "北24条", "麻生", "屯田", "篠路", "あいの里"],
        "point1_title": "文教地区・学生街、引越しシーズン需要高",
        "point1_text": """北区は京都府大学など教育機関が多い文教地区で、学生向けの賃貸物件が多いエリアです。
...
学生向けのお得なプランを提供している業者も多く、選択肢が豊富です。""",
        "point2_title": "豪雪地帯、冬季の暖房汚れ・結露対策重要",
        "point2_text": """北区は豪雪地帯で、冬季（11-3月）は暖房を長時間使用するため、室内汚れが蓄積しやすい環境です。
暖房によるエアコン内部の汚れや、窓ガラスの結露によるカビの発生に注意が必要です。
春先（4-5月）のエアコンクリーニングと窓清掃で、冬季の汚れをリセットすることが重要です。""",
        "point3_title": "JR・地下鉄など交通良好、業者の選択肢豊富",
        "point3_text": """北区はJR函館本線、地下鉄南北線などが通っており、交通の便が良好です。
北24条駅、北18条駅、麻生駅など主要駅があり、京都駅へもアクセスしやすいエリアです。
多くのハウスクリーニング業者が対応しており、大手チェーンから地域密着型まで選択肢が豊富です。""",
    },
    {
        "slug": "sapporo-higashi",
        "name": "東区",
        "reading": "ひがし-く",
        "intro": "東区は京都市の東部に位置し、住宅地と商業地が混在するエリアです。サッポロビール園など観光施設もあります。",
        "areas": ["栄町", "元町", "北光", "東苗穂", "札苗", "モエレ沼"],
        "point1_title": "住宅地・商業地混在、生活密着型サービス需要",
        "point1_text": """東区は住宅地と商業地が混在するエリアで、生活密着型のハウスクリーニングサービスの需要が高いです。
ファミリー層が多く、在宅クリーニングの需要が高いです。
広めの物件が多く、セットプラン（エアコン複数台+浴室+キッチンなど）がお得です。""",
        "point2_title": "豪雪地帯、冬季の暖房汚れ・結露対策重要",
        "point2_text": """東区は豪雪地帯で、冬季（11-3月）は暖房を長時間使用するため、室内汚れが蓄積しやすい環境です。
暖房によるエアコン内部の汚れや、窓ガラスの結露によるカビの発生に注意が必要です。
春先（4-5月）のエアコンクリーニングと窓清掃で、冬季の汚れをリセットすることが重要です。""",
        "point3_title": "地下鉄東豊線など交通良好、業者の選択肢豊富",
        "point3_text": """東区は地下鉄東豊線などが通っており、交通の便が良好です。
栄町駅、元町駅、環状通東駅など主要駅があり、京都駅へもアクセスしやすいエリアです。
多くのハウスクリーニング業者が対応しており、選択肢が豊富です。""",
    },
    {
        "slug": "sapporo-shiroishi",
        "name": "白石区",
        "reading": "しろいし-く",
        "intro": "白石区は京都市の東部に位置し、住宅地が中心のエリアです。古くからの市街地と新興住宅地が混在しています。",
        "areas": ["白石", "菊水", "南郷", "北郷", "東京都", "川下"],
        "point1_title": "住宅地中心、カビ・湿気対策重要",
        "point1_text": """白石区は住宅地が中心のエリアで、古くからの住宅も多いです。
古い住宅では湿気がこもりやすく、カビが発生しやすい環境です。
特に浴室やキッチンの水回りは、カビが発生しやすくなります。
プロによる浴室クリーニング（年1回）と換気扇清掃で、カビの発生を抑えることができます。""",
        "point2_title": "豪雪地帯、冬季の暖房汚れ・結露対策重要",
        "point2_text": """白石区は豪雪地帯で、冬季（11-3月）は暖房を長時間使用するため、室内汚れが蓄積しやすい環境です。
暖房によるエアコン内部の汚れや、窓ガラスの結露によるカビの発生に注意が必要です。
春先（4-5月）のエアコンクリーニングと窓清掃で、冬季の汚れをリセットすることが重要です。""",
        "point3_title": "地下鉄東西線など交通良好、業者の選択肢豊富",
        "point3_text": """白石区は地下鉄東西線などが通っており、交通の便が良好です。
白石駅、菊水駅、東京都駅など主要駅があり、京都駅へもアクセスしやすいエリアです。
多くのハウスクリーニング業者が対応しており、選択肢が豊富です。""",
    },
    {
        "slug": "sapporo-toyohira",
        "name": "豊平区",
        "reading": "とよひら-く",
        "intro": "豊平区は京都市の中央部に位置し、豊平川沿いに広がる住宅地です。京都ドームがあり、スポーツ施設も充実しています。",
        "areas": ["豊平", "美園", "月寒", "福住", "平岸", "中の島"],
        "point1_title": "豊平川沿いエリア、湿気・カビ対策重要",
        "point1_text": """豊平区は豊平川沿いに広がるエリアで、河川による湿気が問題となることがあります。
特に春先（4-5月）や梅雨前（6月）は湿気が高く、カビが発生しやすい環境です。
浴室やキッチンの水回りは、カビが発生しやすくなります。
プロによる浴室クリーニング（年1回）と換気扇清掃で、カビの発生を抑えることができます。""",
        "point2_title": "豪雪地帯、冬季の暖房汚れ・結露対策重要",
        "point2_text": """豊平区は豪雪地帯で、冬季（11-3月）は暖房を長時間使用するため、室内汚れが蓄積しやすい環境です。
暖房によるエアコン内部の汚れや、窓ガラスの結露によるカビの発生に注意が必要です。
春先（4-5月）のエアコンクリーニングと窓清掃で、冬季の汚れをリセットすることが重要です。""",
        "point3_title": "地下鉄東豊線・南北線など交通良好、業者の選択肢豊富",
        "point3_text": """豊平区は地下鉄東豊線、南北線などが通っており、交通の便が良好です。
福住駅、豊平公園駅、美園駅、平岸駅など主要駅があり、京都駅へもアクセスしやすいエリアです。
多くのハウスクリーニング業者が対応しており、選択肢が豊富です。""",
    },
    {
        "slug": "sapporo-minami",
        "name": "南区",
        "reading": "みなみ-く",
        "intro": "南区は京都市の南部に位置し、山間部が広がる自然豊かなエリアです。温泉やスキー場など観光施設も多いです。",
        "areas": ["真駒内", "藤野", "定山渓", "簾舞", "澄川", "南沢"],
        "point1_title": "山間部・自然豊か、花粉・虫対策重要",
        "point1_text": """南区は山間部が広がる自然豊かなエリアです。
春の花粉シーズン（4-5月）には花粉がエアコンのフィルターに詰まりやすくなります。
また、夏場（6-9月）は虫が多く、網戸や窓枠に虫の死骸が溜まりやすくなります。
エアコンクリーニング（年1回、特に使用前の5-6月）と窓清掃で、快適な室内環境を保てます。""",
        "point2_title": "豪雪地帯、冬季の暖房汚れ・雪害対策特に重要",
        "point2_text": """南区は京都市内でも特に積雪が多いエリアで、冬季（11-3月）は暖房を長時間使用します。
室内汚れが蓄積しやすく、窓ガラスの結露によるカビの発生にも注意が必要です。
また、積雪によるエアコン室外機の凍結や故障にも注意が必要です。
春先（4-5月）のエアコンクリーニングと窓清掃で、冬季の汚れをリセットすることが重要です。""",
        "point3_title": "地下鉄南北線など交通やや不便、地域密着型業者豊富",
        "point3_text": """南区は地下鉄南北線が通っていますが、山間部は交通がやや不便です。
真駒内駅、自衛隊前駅、澄川駅など主要駅がありますが、京都駅へのアクセスは時間がかかります。
地域密着型のハウスクリーニング業者が多数あり、地元の特性を理解した業者が多いエリアです。""",
    },
    {
        "slug": "sapporo-nishi",
        "name": "西区",
        "reading": "にし-く",
        "intro": "西区は京都市の西部に位置し、住宅地が広がるエリアです。宮の沢など商業施設も発展しています。",
        "areas": ["宮の沢", "発寒", "琴似", "八軒", "二十四軒", "西野"],
        "point1_title": "住宅地中心、ファミリー向けサービス需要",
        "point1_text": """西区は住宅地が中心で、ファミリー層が多いエリアです。
在宅クリーニングの需要が高く、広めの物件（2LDK〜）が多いです。
ファミリー向けのセットプラン（エアコン複数台+浴室+キッチンなど）がお得です。
見積もり時に複数箇所の清掃を依頼すると、セット割引が適用されることが多いです。""",
        "point2_title": "豪雪地帯、冬季の暖房汚れ・結露対策重要",
        "point2_text": """西区は豪雪地帯で、冬季（11-3月）は暖房を長時間使用するため、室内汚れが蓄積しやすい環境です。
暖房によるエアコン内部の汚れや、窓ガラスの結露によるカビの発生に注意が必要です。
春先（4-5月）のエアコンクリーニングと窓清掃で、冬季の汚れをリセットすることが重要です。""",
        "point3_title": "地下鉄東西線・JRなど交通良好、業者の選択肢豊富",
        "point3_text": """西区は地下鉄東西線、JR函館本線などが通っており、交通の便が良好です。
宮の沢駅、発寒南駅、琴似駅など主要駅があり、京都駅へもアクセスしやすいエリアです。
多くのハウスクリーニング業者が対応しており、選択肢が豊富です。""",
    },
    {
        "slug": "sapporo-atsubetsu",
        "name": "厚別区",
        "reading": "あつべつ-く",
        "intro": "厚別区は京都市の東部に位置し、ニュータウンとして計画的に開発されたエリアです。新京都駅周辺は商業施設が充実しています。",
        "areas": ["新京都", "厚別", "大谷地", "もみじ台", "青葉", "厚別西"],
        "point1_title": "ニュータウン・計画都市、新しい住宅多い",
        "point1_text": """厚別区はニュータウンとして計画的に開発されたエリアで、新しい住宅が多いです。
最新の設備が導入されていますが、定期的なメンテナンスは重要です。
エアコンクリーニング（年1回、特に使用前の5-6月）で快適な室内環境を保てます。
新築・築浅物件でも、使用開始2-3年でエアコン内部にカビが発生することがあります。""",
        "point2_title": "豪雪地帯、冬季の暖房汚れ・結露対策重要",
        "point2_text": """厚別区は豪雪地帯で、冬季（11-3月）は暖房を長時間使用するため、室内汚れが蓄積しやすい環境です。
暖房によるエアコン内部の汚れや、窓ガラスの結露によるカビの発生に注意が必要です。
春先（4-5月）のエアコンクリーニングと窓清掃で、冬季の汚れをリセットすることが重要です。""",
        "point3_title": "JR・地下鉄東西線など交通良好、業者の選択肢豊富",
        "point3_text": """厚別区はJR千歳線、地下鉄東西線などが通っており、交通の便が良好です。
新京都駅、大谷地駅、ひばりが丘駅など主要駅があり、京都駅へもアクセスしやすいエリアです。
多くのハウスクリーニング業者が対応しており、選択肢が豊富です。""",
    },
    {
        "slug": "sapporo-teine",
        "name": "手稲区",
        "reading": "ていね-く",
        "intro": "手稲区は京都市の西部に位置し、手稲山の麓に広がる住宅地です。スキー場もあり、冬季スポーツが盛んです。",
        "areas": ["手稲", "稲穂", "前田", "星置", "富丘", "新発寒"],
        "point1_title": "手稲山麓、積雪多い地域で雪害対策重要",
        "point1_text": """手稲区は手稲山の麓に位置し、京都市内でも積雪が多いエリアです。
冬季（11-3月）は暖房を長時間使用し、室内汚れが蓄積しやすい環境です。
また、積雪によるエアコン室外機の凍結や故障にも注意が必要です。
春先（4-5月）のエアコンクリーニングと窓清掃で、冬季の汚れをリセットすることが重要です。""",
        "point2_title": "住宅地中心、ファミリー向けサービス需要",
        "point2_text": """手稲区は住宅地が中心で、ファミリー層が多いエリアです。
在宅クリーニングの需要が高く、広めの物件が多いです。
ファミリー向けのセットプラン（エアコン複数台+浴室+キッチンなど）がお得です。""",
        "point3_title": "JR函館本線など交通良好、業者の選択肢豊富",
        "point3_text": """手稲区はJR函館本線などが通っており、交通の便が良好です。
手稲駅、稲穂駅、星置駅など主要駅があり、京都駅へもアクセスしやすいエリアです。
多くのハウスクリーニング業者が対応しており、選択肢が豊富です。""",
    },
    {
        "slug": "sapporo-kiyota",
        "name": "清田区",
        "reading": "きよた-く",
        "intro": "清田区は京都市の南東部に位置し、住宅地が広がるエリアです。緑豊かで、ファミリー層に人気です。",
        "areas": ["清田", "平岡", "里塚", "真栄", "北野", "美しが丘"],
        "point1_title": "住宅地中心、ファミリー向けサービス需要",
        "point1_text": """清田区は住宅地が中心で、ファミリー層が多いエリアです。
在宅クリーニングの需要が高く、広めの物件（2LDK〜）が多いです。
ファミリー向けのセットプラン（エアコン複数台+浴室+キッチンなど）がお得です。
見積もり時に複数箇所の清掃を依頼すると、セット割引が適用されることが多いです。""",
        "point2_title": "豪雪地帯、冬季の暖房汚れ・結露対策重要",
        "point2_text": """清田区は豪雪地帯で、冬季（11-3月）は暖房を長時間使用するため、室内汚れが蓄積しやすい環境です。
暖房によるエアコン内部の汚れや、窓ガラスの結露によるカビの発生に注意が必要です。
春先（4-5月）のエアコンクリーニングと窓清掃で、冬季の汚れをリセットすることが重要です。""",
        "point3_title": "地下鉄東豊線など交通やや不便、地域密着型業者豊富",
        "point3_text": """清田区は地下鉄東豊線の福住駅が最寄りですが、区内の多くは駅から離れており、交通はやや不便です。
...
def generate_ward_page(ward):
    ...
    # 近隣エリアリンク（京都市の他の区）
    neighbors = []
    for w in KYOTO_WARDS:
        if w['slug'] != ward['slug']:
            neighbors.append({'slug': w['slug'], 'name': f"京都市{w['name']}"})
    
    # エリアリストを文字列に変換
    areas_str = ', '.join([f"'{a}'" for a in ward['areas']])
    
    # 区名からコンポーネント名を生成
    component_name = ward['slug'].replace('sapporo-', '').title().replace('-', '')
    
    template = f'''import Link from "next/link";
import {{ Sparkles, Award, Shield, Zap }} from "lucide-react";

export const metadata = {{
  title: "京都市{ward['name']}のハウスクリーニング業者おすすめ比較 | クリーンナビ",
  description: "京都市{ward['name']}でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
}};

export default function Kyoto{component_name}Area() {{
    ...
    <div className="min-h-screen bg-base-100">
      ...
      <section className="bg-gradient-to-r from-primary to-secondary text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">京都市{ward['name']}のハウスクリーニング業者比較</h1>
      ...
      <section className="py-12 bg-base-100">
        <div className="container mx-auto px-4">
          <div className="prose max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-4">京都市{ward['name']}でハウスクリーニングを依頼するなら？</h2>
            ...
            <div className="space-y-4">
              <div className="collapse collapse-arrow bg-base-100 border">
                ...
                <div className="collapse-title text-xl font-bold">
                  Q. 京都市{ward['name']}でハウスクリーニングの料金相場はいくらですか？
                </div>
              ...
              <div className="collapse collapse-arrow bg-base-100 border">
                <input type="checkbox" />
                <div className="collapse-title text-xl font-bold">
                  Q. 冬季（11-3月）でも依頼できますか？
                </div>
                <div className="collapse-content">
                  <p className="text-lg">京都市では冬季も対応可能な業者が多数あります。ただし、積雪による作業の遅延や、エアコン室外機の凍結などに注意が必要です。春先（4-5月）がおすすめです。</p>
                </div>
              </div>
              ...
              <div className="collapse collapse-arrow bg-base-100 border">
                ...
                <div className="collapse-content">
                  <p className="text-lg">エアコンは年1回（使用前の5-6月）、浴室・キッチンは半年〜1年に1回が目安です。京都市は冬季暖房汚れが多いため、春先のクリーニングが特に重要です。</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="prose max-w-4xl mx-auto">
            ...
            <div className="bg-primary/10 border-l-4 border-primary p-6 mb-6">
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>{ward['name']}の環境（豪雪地帯）に適した業者を選ぶ</li>
              </ul>
            </div>
      ...
      <section className="py-16 bg-base-200">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <Link href="/areas/sapporo" className="btn btn-outline">京都府</Link>
'''
...
def main():
    ...
    print(f"\n完了: 京都市{len(KYOTO_WARDS)}区のページ生成完了")
