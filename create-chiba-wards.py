...
def generate_ward_page(ward):
    ...
    # 近隣エリアリンク（千葉市の他の区）
    neighbors = []
    for w in CHIBA_WARDS:
        if w['slug'] != ward['slug']:
            neighbors.append({'slug': w['slug'], 'name': f"千葉市{w['name']}"})
...
export const metadata = {{
  title: "千葉市{ward['name']}のハウスクリーニング業者おすすめ比較 | クリーンナビ",
  description: "千葉市{ward['name']}でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
}};

export default function Chiba{ward['name'].replace('区', '')}Area() {{
    ...
    <div className="min-h-screen bg-base-100">
      ...
      <section className="bg-gradient-to-r from-primary to-secondary text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">千葉市{ward['name']}のハウスクリーニング業者比較</h1>
      ...
      <section className="py-12 bg-base-100">
        <div className="container mx-auto px-4">
          <div className="prose max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-4">千葉市{ward['name']}でハウスクリーニングを依頼するなら？</h2>
            ...
            <div className="space-y-4">
              <div className="collapse collapse-arrow bg-base-100 border">
                ...
                <div className="collapse-title text-xl font-bold">
                  Q. 千葉市{ward['name']}でハウスクリーニングの料金相場はいくらですか？
                </div>
...
def main():
    ...
    print(f"\n完了: 千葉市{len(CHIBA_WARDS)}区のページ生成完了")
