...
SAPPORO_WARDS = [
    {
        ...
        "name": "中央区",
        "reading": "ちゅうおう-く",
        "intro": "中央区は札幌市の中心部に位置し、札幌駅・大通・すすきのがある札幌の中心街です。商業施設が集積し、観光地も多いエリアです。",
        "areas": ["札幌駅前", "大通", "すすきの", "円山", "宮の森", "中島公園"],
        "point1_title": "札幌駅・大通など中心街、都市汚れ・排気ガス対策重要",
        "point1_text": """中央区は札幌駅・大通・すすきのなど札幌市の中心街で、人通り・車通りが非常に多いエリアです。
...
札幌駅、大通駅、すすきの駅など主要駅が多数あり、札幌市内各地からアクセスしやすいエリアです。
...
即日対応可能な業者も多数あり、複数社を比較することで、最適な業者を見つけやすい環境といえます。""",
    },
    {
        ...
        "name": "北区",
        "reading": "きた-く",
        "intro": "北区は札幌市の北部に位置し、北海道大学がある文教地区として知られています。学生街と住宅地が混在しています。",
        "areas": ["北大前", "北24条", "麻生", "屯田", "篠路", "あいの里"],
        "point1_title": "文教地区・学生街、引越しシーズン需要高",
        "point1_text": """北区は北海道大学など教育機関が多い文教地区で、学生向けの賃貸物件が多いエリアです。
...
北24条駅、北18条駅、麻生駅など主要駅があり、札幌駅へもアクセスしやすいエリアです。
多くのハウスクリーニング業者が対応しており、大手チェーンから地域密着型まで選択肢が豊富です。""",
    },
    {
        ...
        "name": "東区",
        "reading": "ひがし-く",
        "intro": "東区は札幌市の東部に位置し、住宅地と商業地が混在するエリアです。サッポロビール園など観光施設もあります。",
...
栄町駅、元町駅、環状通東駅など主要駅があり、札幌駅へもアクセスしやすいエリアです。
多くのハウスクリーニング業者が対応しており、選択肢が豊富です。""",
    },
    {
        ...
        "name": "白石区",
        "reading": "しろいし-く",
        "intro": "白石区は札幌市の東部に位置し、住宅地が中心のエリアです。古くからの市街地と新興住宅地が混在しています。",
        "areas": ["白石", "菊水", "南郷", "北郷", "東札幌", "川下"],
...
白石駅、菊水駅、東札幌駅など主要駅があり、札幌駅へもアクセスしやすいエリアです。
多くのハウスクリーニング業者が対応しており、選択肢が豊富です。""",
    },
    {
        ...
        "name": "豊平区",
        "reading": "とよひら-く",
        "intro": "豊平区は札幌市の中央部に位置し、豊平川沿いに広がる住宅地です。札幌ドームがあり、スポーツ施設も充実しています。",
...
福住駅、豊平公園駅、美園駅、平岸駅など主要駅があり、札幌駅へもアクセスしやすいエリアです。
多くのハウスクリーニング業者が対応しており、選択肢が豊富です。""",
    },
    {
        "slug": "sapporo-minami",
        "name": "南区",
        "reading": "みなみ-く",
        "intro": "南区は札幌市の南部に位置し、山間部が広がる自然豊かなエリアです。温泉やスキー場など観光施設も多いです。",
...
エアコンクリーニング（年1回、特に使用前の5-6月）と窓清掃で、快適な室内環境を保てます。""",
        ...
        "point2_text": """南区は札幌市内でも特に積雪が多いエリアで、冬季（11-3月）は暖房を長時間使用します。
...
真駒内駅、自衛隊前駅、澄川駅など主要駅がありますが、札幌駅へのアクセスは時間がかかります。
地域密着型のハウスクリーニング業者が多数あり、地元の特性を理解した業者が多いエリアです。""",
    },
    {
        ...
        "name": "西区",
        "reading": "にし-く",
        "intro": "西区は札幌市の西部に位置し、住宅地が広がるエリアです。宮の沢など商業施設も発展しています。",
...
宮の沢駅、発寒南駅、琴似駅など主要駅があり、札幌駅へもアクセスしやすいエリアです。
多くのハウスクリーニング業者が対応しており、選択肢が豊富です。""",
    },
    {
        ...
        "name": "厚別区",
        "reading": "あつべつ-く",
        "intro": "厚別区は札幌市の東部に位置し、ニュータウンとして計画的に開発されたエリアです。新札幌駅周辺は商業施設が充実しています。",
        "areas": ["新札幌", "厚別", "大谷地", "もみじ台", "青葉", "厚別西"],
...
新札幌駅、大谷地駅、ひばりが丘駅など主要駅があり、札幌駅へもアクセスしやすいエリアです。
多くのハウスクリーニング業者が対応しており、選択肢が豊富です。""",
    },
    {
        "slug": "sapporo-teine",
        "name": "手稲区",
        "reading": "ていね-く",
        "intro": "手稲区は札幌市の西部に位置し、手稲山の麓に広がる住宅地です。スキー場もあり、冬季スポーツが盛んです。",
        "areas": ["手稲", "稲穂", "前田", "星置", "富丘", "新発寒"],
        "point1_title": "手稲山麓、積雪多い地域で雪害対策重要",
        "point1_text": """手稲区は手稲山の麓に位置し、札幌市内でも積雪が多いエリアです。
...
手稲駅、稲穂駅、星置駅など主要駅があり、札幌駅へもアクセスしやすいエリアです。
多くのハウスクリーニング業者が対応しており、選択肢が豊富です。""",
    },
    {
        "slug": "sapporo-kiyota",
        "name": "清田区",
        "reading": "きよた-く",
        "intro": "清田区は札幌市の南東部に位置し、住宅地が広がるエリアです。緑豊かで、ファミリー層に人気です。",
...
export default function Sapporo{component_name}Area() {{
          ...
          <div className="prose max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="collapse collapse-arrow bg-base-100 border">
                ...
                <div className="collapse-content">
                  <p className="text-lg">札幌市では冬季も対応可能な業者が多数あります。ただし、積雪による作業の遅延や、エアコン室外機の凍結などに注意が必要です。春先（4-5月）がおすすめです。</p>
                </div>
              </div>
              ...
              <div className="collapse collapse-arrow bg-base-100 border">
                ...
                <div className="collapse-content">
                  <p className="text-lg">エアコンは年1回（使用前の5-6月）、浴室・キッチンは半年〜1年に1回が目安です。札幌市は冬季暖房汚れが多いため、春先のクリーニングが特に重要です。</p>
                </div>
              </div>
            </div>
          </div>
