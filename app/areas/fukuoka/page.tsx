...
export const metadata = {
  title: "福岡県のハウスクリーニング業者比較 | クリーンナビ",
  description: "福岡県でおすすめのハウスクリーニング業者を比較。料金相場、口コミ評価掲載。",
};
    ...
    <div className="min-h-screen bg-base-100">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-8">福岡県のハウスクリーニング業者</h1>
          <p className="text-xl mb-8">福岡県全域対応！信頼できる業者をご紹介</p>
