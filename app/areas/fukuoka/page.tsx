...
export const metadata = {
 ...
 description: "福岡県でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
 openGraph: {
 title: "福岡県のハウスクリーニング業者おすすめ比較 | クリーンナビ",
 description: "福岡県でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
 url: "https://cleaning-choices.com/areas/fukuoka/",
 siteName: "クリーンナビ",
 images: [
 {
 ...
 alternates: {
 canonical: "https://cleaning-choices.com/areas/fukuoka/",
 },
};
...
export default function FukuokaArea() {
 ...
 <img src="https://images.unsplash.com/photo-1619246710998-8dfbfd98a96e?auto=format&fit=crop&w=1920&q=80"alt="福岡県の街並み"/>
 </div>
 ...
 <CityProviders match={["福岡市"]} cityJa="福岡市" />
