...
export const metadata = {
 ...
 title: "杉並区のハウスクリーニング業者おすすめ比較 | クリーンナビ",
 description: "杉並区でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
 url: "https://cleaning-choices.com/areas/tokyo-suginami/",
 siteName: "クリーンナビ",
 images: [
 {
 ...
 alternates: {
 canonical: "https://cleaning-choices.com/areas/tokyo-suginami/",
 },
};
...
export default function TokyoSuginamiArea() {
 ...
 <AreaProvidersLead slug="tokyo-suginami" />
 {/* パンくずリスト */}
