...
export const metadata = {
  ...
  openGraph: {
    title: "新宿区のハウスクリーニング業者おすすめ比較 | クリーンナビ",
    description: "新宿区でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
    url: "https://cleaning-choices.com/areas/tokyo-shinjuku/",
    siteName: "クリーンナビ",
    images: [
      {
  ...
  alternates: {
    canonical: "https://cleaning-choices.com/areas/tokyo-shinjuku/",
  },
};
    ...
    <div className="min-h-screen bg-base-100">
      <section className="bg-gradient-to-r from-primary to-secondary text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl">新宿区全域対応！信頼できる業者をご紹介</p>
        </div>
      </section>
 <AreaProvidersLead slug="tokyo-shinjuku" />
      ...
      <section className="py-12 bg-base-100">
        <div className="container mx-auto px-4">
          <div className="prose max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-4">新宿区でハウスクリーニングを依頼するなら？</h2>
            <p className="text-lg">新宿区は東京の副都心として発展し、高層ビルと住宅地が混在する都市です。人口密度が高く、ハウスクリーニングの需要が高いエリアです。</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-primary to-secondary text-white text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-4">新宿区で最適な業者を見つけよう</h2>
