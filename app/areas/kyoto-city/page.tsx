...
export const metadata = {
  title: "京都市のハウスクリーニング業者おすすめ比較 | クリーンナビ",
  description: "京都市でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
  openGraph: {
    title: "京都市のハウスクリーニング業者おすすめ比較 | クリーンナビ",
    description: "京都市でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
    url: "https://cleaning-choices.com/areas/kyoto-city/",
    siteName: "クリーンナビ",
    images: [
      {
  ...
  alternates: {
    canonical: "https://cleaning-choices.com/areas/kyoto-city/",
  },
};

export default function KyotocityArea() {
    ...
    <div className="min-h-screen bg-base-100">
      ...
      <section className="hero-section py-16 md:py-20 relative">
        <div className="hero-bg">
          <img src="https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=1920&q=80" alt="京都府の街並み" />
        </div>
      ...
      <section className="py-12 bg-base-100">
        <div className="container mx-auto px-4">
          <div className="prose max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-4">京都市でハウスクリーニングを依頼するなら？</h2>
            <p className="text-lg">京都市は古都として知られ、歴史的建造物が多い都市です。盆地気候で湿気が多く、カビ対策が特に重要です。</p>
          </div>
        </div>
      </section>
