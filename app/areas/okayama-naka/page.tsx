...
export const metadata = {
 ...
 title: "中区のハウスクリーニング業者おすすめ比較 | クリーンナビ",
 description: "中区でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
 url: "https://cleaning-choices.com/areas/okayama-naka/",
 siteName: "クリーンナビ",
 images: [
 {
 ...
 alternates: {
 canonical: "https://cleaning-choices.com/areas/okayama-naka/",
 },
};

export default function Area_okayama_naka() {
 ...
 <h1 className="text-4xl font-bold mb-4">岡山市中区のハウスクリーニング業者比較</h1>
 <p className="text-xl">中区全域対応！信頼できる業者をご紹介</p>
 </div>
 </section>
 <AreaProvidersLead slug="okayama-naka" />
 {/* パンくずリスト */}
 ...
 <h2 className="text-2xl font-bold mb-4">岡山市中区でハウスクリーニングを依頼するなら？</h2>
 <p className="text-lg">中区は岡山市中部に位置し、旭川東岸の住宅地と商業地が広がるエリアです。</p>
 <p className="text-lg mt-4">本記事では、中区全域対応の<strong>おすすめハウスクリーニング業者15社</strong>を徹底比較。料金、サービス内容、営業時間などの詳細情報を掲載しています。</p>
 </div>
 </div>
 </section>
 ...
 <p>中区は業者が多いため、最低3社から見積もりを取ることをおすすめします。</p>
 </div>
 </div>
 ...
 <div className="border-l-4 border-primary pl-6 py-4">
 <h3 className="text-xl font-bold mb-2">✓ 中区の環境に適した業者を選ぶ</h3>
 <p className="text-lg">中区は岡山市中部に位置し、旭川東岸の住宅地と商業地が広がるエリアです。見積もり時に地域特性を伝えると、適切な提案がもらえます。</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="collapse-content">
 <p className="text-lg">中区は業者数が多く、即日対応可能な業者もあります。ただし、繁忙期（3-4月、9-10月）は予約が取りづらいため、1週間前の予約がおすすめです。</p>
 </div>
 </div>
 ...
 中区は岡山市中部に位置し、旭川東岸の住宅地と商業地が広がるエリアです。
 ...
 <Link href="/areas/okayama-minami/"className="btn btn-outline">岡山市南区</Link>
