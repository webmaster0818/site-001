...
export const metadata = {
 ...
 title: "南区のハウスクリーニング業者おすすめ比較 | クリーンナビ",
 description: "南区でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
 url: "https://cleaning-choices.com/areas/hiroshima-minami/",
 siteName: "クリーンナビ",
 images: [
 {
 ...
 alternates: {
 canonical: "https://cleaning-choices.com/areas/hiroshima-minami/",
 },
};

export default function Area_hiroshima_minami() {
 ...
 const areas = ['広島駅南側', '宇品', '段原', '皆実町', '大州'];
 ...
 <h1 className="text-4xl font-bold mb-4">広島市南区のハウスクリーニング業者比較</h1>
 <p className="text-xl">南区全域対応！信頼できる業者をご紹介</p>
 </div>
 </section>
 <AreaProvidersLead slug="hiroshima-minami" />
 {/* パンくずリスト */}
 ...
 <h2 className="text-2xl font-bold mb-4">広島市南区でハウスクリーニングを依頼するなら？</h2>
 <p className="text-lg">南区は広島市南部の臨海・港湾エリアで、広島駅南側や宇品港、スタジアム周辺があるエリアです。</p>
 ...
 <p className="text-lg">南区は広島市南部の臨海・港湾エリアで、広島駅南側や宇品港、スタジアム周辺があるエリアです。見積もり時に地域特性を伝えると、適切な提案がもらえます。</p>
 </div>
 </div>
 </div>
 </div>
 ...
 南区は広島市南部の臨海・港湾エリアで、広島駅南側や宇品港、スタジアム周辺があるエリアです。
