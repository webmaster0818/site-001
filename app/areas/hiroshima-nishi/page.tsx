...
export const metadata = {
 ...
 title: "西区のハウスクリーニング業者おすすめ比較 | クリーンナビ",
 description: "西区でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
 url: "https://cleaning-choices.com/areas/hiroshima-nishi/",
 siteName: "クリーンナビ",
 images: [
 {
 ...
 alternates: {
 canonical: "https://cleaning-choices.com/areas/hiroshima-nishi/",
 },
};

export default function Area_hiroshima_nishi() {
 ...
 const areas = ['横川', '己斐', '西広島', '観音', '商工センター'];
 ...
 <h1 className="text-4xl font-bold mb-4">広島市西区のハウスクリーニング業者比較</h1>
 <p className="text-xl">西区全域対応！信頼できる業者をご紹介</p>
 </div>
 </section>
 <AreaProvidersLead slug="hiroshima-nishi" />
 {/* パンくずリスト */}
 ...
 <h2 className="text-2xl font-bold mb-4">広島市西区でハウスクリーニングを依頼するなら？</h2>
 <p className="text-lg">西区は広島市西部の住商エリアで、横川・己斐や商工センターがあるエリアです。</p>
 ...
 <p className="text-lg">西区は広島市西部の住商エリアで、横川・己斐や商工センターがあるエリアです。見積もり時に地域特性を伝えると、適切な提案がもらえます。</p>
 </div>
 </div>
 </div>
 </div>
 ...
 西区は広島市西部の住商エリアで、横川・己斐や商工センターがあるエリアです。
