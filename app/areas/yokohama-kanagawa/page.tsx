...
export const metadata = {
 ...
 title: "神奈川区のハウスクリーニング業者おすすめ比較 | クリーンナビ",
 description: "神奈川区でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
 url: "https://cleaning-choices.com/areas/yokohama-kanagawa/",
 siteName: "クリーンナビ",
 images: [
 {
 ...
 alternates: {
 canonical: "https://cleaning-choices.com/areas/yokohama-kanagawa/",
 },
};
...
export default function YokohamaKanagawaArea() {
 ...
 <AreaProvidersLead slug="yokohama-kanagawa" />
 {/* パンくずリスト */}
