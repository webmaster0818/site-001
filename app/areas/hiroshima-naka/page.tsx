...
export const metadata = {
 ...
 title: "中区のハウスクリーニング業者おすすめ比較 | クリーンナビ",
 description: "中区でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
 url: "https://cleaning-choices.com/areas/hiroshima-naka/",
 siteName: "クリーンナビ",
 images: [
 {
 ...
 alternates: {
 canonical: "https://cleaning-choices.com/areas/hiroshima-naka/",
 },
};

export default function Area_hiroshima_naka() {
 ...
 <h1 className="text-4xl font-bold mb-4">広島市中区のハウスクリーニング業者比較</h1>
 <p className="text-xl">中区全域対応！信頼できる業者をご紹介</p>
 </div>
 </section>
 <AreaProvidersLead slug="hiroshima-naka" />
 {/* パンくずリスト */}
 ...
 <h2 className="text-2xl font-bold mb-4">広島市中区でハウスクリーニングを依頼するなら？</h2>
 <p className="text-lg">中区は広島市の中心部に位置し、紙屋町・八丁堀など商業の中心や官公庁が集まる広島の中心街です。</p>
 ...
 <p className="text-lg">中区は広島市の中心部に位置し、紙屋町・八丁堀など商業の中心や官公庁が集まる広島の中心街です。見積もり時に地域特性を伝えると、適切な提案がもらえます。</p>
 </div>
 </div>
 </div>
 </div>
 ...
 中区は広島市の中心部に位置し、紙屋町・八丁堀など商業の中心や官公庁が集まる広島の中心街です。
