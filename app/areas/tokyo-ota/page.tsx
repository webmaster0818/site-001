...
export const metadata = {
  title: "東京都大田区のハウスクリーニング業者比較 | クリーンナビ",
  description: "東京都大田区でおすすめのハウスクリーニング業者を比較。即日対応、料金相場、口コミ評価掲載。",
};
    ...
    <div className="min-h-screen bg-base-100">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-8">東京都大田区のハウスクリーニング業者</h1>
          <p className="text-xl mb-8">大田区全域対応！信頼できる業者をご紹介</p>
