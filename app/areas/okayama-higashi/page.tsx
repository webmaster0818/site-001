...
export const metadata = {
 ...
 title: "東区のハウスクリーニング業者おすすめ比較 | クリーンナビ",
 description: "東区でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
 url: "https://cleaning-choices.com/areas/okayama-higashi/",
 siteName: "クリーンナビ",
 images: [
 {
 ...
 alternates: {
 canonical: "https://cleaning-choices.com/areas/okayama-higashi/",
 },
};

export default function Area_okayama_higashi() {
 ...
 <h1 className="text-4xl font-bold mb-4">岡山市東区のハウスクリーニング業者比較</h1>
 <p className="text-xl">東区全域対応！信頼できる業者をご紹介</p>
 </div>
 </section>
 <AreaProvidersLead slug="okayama-higashi" />
 {/* パンくずリスト */}
 ...
 <h2 className="text-2xl font-bold mb-4">岡山市東区でハウスクリーニングを依頼するなら？</h2>
 <p className="text-lg">東区は岡山市東部に位置し、西大寺を中心に市街地と田園が広がるエリアです。</p>
 ...
 <p className="text-lg">東区は岡山市東部に位置し、西大寺を中心に市街地と田園が広がるエリアです。見積もり時に地域特性を伝えると、適切な提案がもらえます。</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="collapse-content">
 <p className="text-lg">東区は業者数が多く、即日対応可能な業者もあります。ただし、繁忙期（3-4月、9-10月）は予約が取りづらいため、1週間前の予約がおすすめです。</p>
 </div>
 </div>
 ...
 東区は岡山市東部に位置し、西大寺を中心に市街地と田園が広がるエリアです。
