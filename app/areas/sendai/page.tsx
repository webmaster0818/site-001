...
export default function SendaiArea() {
    ...
    <div className="min-h-screen bg-base-100">
      <section className="bg-gradient-to-r from-primary to-secondary text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">仙台市のハウスクリーニング業者比較</h1>
          <p className="text-xl">仙台市など仙台市全域対応</p>
        </div>
      </section>
 <AreaProvidersLead slug="sendai" />
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="prose max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-4">仙台市でハウスクリーニングを依頼するなら？</h2>
            <p className="text-lg">仙台市は東北最大の都市で、四季がはっきりしています。梅雨時期の湿気対策や、冬の結露対策が重要です。</p>
          </div>
        </div>
      </section>
