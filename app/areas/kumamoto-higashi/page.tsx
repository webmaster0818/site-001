...
export const metadata = {
 ...
 title: "東区のハウスクリーニング業者おすすめ比較 | クリーンナビ",
 description: "東区でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
 url: "https://cleaning-choices.com/areas/kumamoto-higashi/",
 siteName: "クリーンナビ",
 images: [
 {
 ...
 alternates: {
 canonical: "https://cleaning-choices.com/areas/kumamoto-higashi/",
 },
};

export default function Area_kumamoto_higashi() {
 ...
 <h1 className="text-4xl font-bold mb-4">熊本市東区のハウスクリーニング業者比較</h1>
 <p className="text-xl">東区全域対応！信頼できる業者をご紹介</p>
 </div>
 </section>
 <AreaProvidersLead slug="kumamoto-higashi" />
 {/* パンくずリスト */}
 ...
 <h2 className="text-2xl font-bold mb-4">熊本市東区でハウスクリーニングを依頼するなら？</h2>
 <p className="text-lg">東区は熊本市東部に位置し、健軍や東町など住宅地と商業地が広がるエリアです。</p>
 ...
 <p className="text-lg">東区は熊本市東部に位置し、健軍や東町など住宅地と商業地が広がるエリアです。見積もり時に地域特性を伝えると、適切な提案がもらえます。</p>
 </div>
 </div>
 </div>
 </div>
 ...
 東区は熊本市東部に位置し、健軍や東町など住宅地と商業地が広がるエリアです。
 ...
 <Link href="/areas/kumamoto-chuo/"className="btn btn-outline">熊本市東区</Link>
