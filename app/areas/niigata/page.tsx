...
export default function NiigataArea() {
    ...
    <div className="min-h-screen bg-base-100">
      <section className="bg-gradient-to-r from-primary to-secondary text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl">新潟市など新潟県全域対応</p>
        </div>
      </section>

 <CityProviders match={["新潟市"]} cityJa="新潟市" />
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="prose max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-4">新潟県でハウスクリーニングを依頼するなら？</h2>
            <p className="text-lg">新潟県は日本海側の気候で、冬は雪が多い地域です。雪による汚れ対策や、湿気・結露対策が重要です。</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-primary text-white text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-4">新潟県で業者を探す</h2>
 ...
 <PrefProviders pref="niigata" prefJa="新潟県" />
    </div>
  );
}
