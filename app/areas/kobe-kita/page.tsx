...
export const metadata = {
 ...
 title: "北区のハウスクリーニング業者おすすめ比較 | クリーンナビ",
 description: "北区でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
 url: "https://cleaning-choices.com/areas/kobe-kita/",
 siteName: "クリーンナビ",
 images: [
 {
 ...
 alternates: {
 canonical: "https://cleaning-choices.com/areas/kobe-kita/",
 },
};

export default function KobeKitaArea() {
 ...
 const areas = ['鈴蘭台', '北神', '有馬温泉', '淡河', '藤原台', '箕谷'];
 ...
 <h1 className="text-4xl font-bold mb-4">神戸市北区のハウスクリーニング業者比較</h1>
 <p className="text-xl">北区全域対応！信頼できる業者をご紹介</p>
 </div>
 </section>

 <CityProviders match={["神戸市北区"]} cityJa="神戸市北区" />
 {/* パンくずリスト */}
 ...
 <h2 className="text-2xl font-bold mb-4">神戸市北区でハウスクリーニングを依頼するなら？</h2>
 <p className="text-lg">北区は神戸市の北部に位置し、六甲山の北側に広がる山間部のエリアです。自然豊かでニュータウンも発展しています。</p>
...
エアコンクリーニング（年1回、特に使用前の5-6月）と窓清掃で、快適な室内環境を保てます。
 ...
 <h3 className="text-2xl font-bold mb-4 mt-8">ニュータウン多数、新しい住宅と古い住宅混在</h3>
 <p className="text-lg mb-4">
 北区には藤原台、鈴蘭台などニュータウンが多数あり、新しい住宅と古い住宅が混在しています。
新しい建物では最新の設備が導入されていますが、定期的なメンテナンスは重要です。
古い住宅では湿気対策が重要で、カビが発生しやすい環境です。
エアコンクリーニング（年1回）と浴室クリーニングで、快適な室内環境を保てます。
 </p>
 
 <h3 className="text-2xl font-bold mb-4 mt-8">神戸電鉄など交通やや不便、地域密着型業者豊富</h3>
 <p className="text-lg mb-4">
 北区は神戸電鉄が主な交通手段で、三宮や大阪へのアクセスはやや不便です。
...
複数社を比較することで、最適な業者を見つけやすい環境といえます。
 ...
 <p className="text-lg">北区は北区は神戸市の北部に位置し、六甲山の北側に広がる山間部のエリアです。見積もり時に地域特性を伝えると、適切な提案がもらえます。</p>
 </div>
 </div>
 </div>
 </div>
 ...
 北区は神戸市の北部に位置し、六甲山の北側に広がる山間部のエリアです。自然豊かでニュータウンも発展しています。
