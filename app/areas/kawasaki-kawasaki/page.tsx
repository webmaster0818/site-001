...
export const metadata = {
 title: "川崎区のハウスクリーニング業者おすすめ比較 | クリーンナビ",
 description: "川崎区でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
 openGraph: {
 title: "川崎区のハウスクリーニング業者おすすめ比較 | クリーンナビ",
 description: "川崎区でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
 url: "https://cleaning-choices.com/areas/kawasaki-kawasaki/",
 siteName: "クリーンナビ",
 images: [
 {
 ...
 alternates: {
 canonical: "https://cleaning-choices.com/areas/kawasaki-kawasaki/",
 },
};
...
export default function KawasakiKawasakiArea() {
 ...
 <AreaProvidersLead slug="kawasaki-kawasaki" />
 {/* パンくずリスト */}
