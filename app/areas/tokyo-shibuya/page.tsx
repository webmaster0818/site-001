...
export const metadata = {
  title: "渋谷区のハウスクリーニング業者おすすめ比較 | クリーンナビ",
  description: "渋谷区でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
  openGraph: {
    title: "渋谷区のハウスクリーニング業者おすすめ比較 | クリーンナビ",
    description: "渋谷区でおすすめのハウスクリーニング業者を徹底比較。全域対応。料金相場、口コミ評価を掲載。",
    url: "https://cleaning-choices.com/areas/tokyo-shibuya/",
    siteName: "クリーンナビ",
    images: [
      {
  ...
  alternates: {
    canonical: "https://cleaning-choices.com/areas/tokyo-shibuya/",
  },
};
    ...
    <div className="min-h-screen bg-base-100">
      <section className="bg-gradient-to-r from-primary to-secondary text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl">渋谷区全域対応！信頼できる業者をご紹介</p>
        </div>
      </section>
 <AreaProvidersLead slug="tokyo-shibuya" />
      ...
      <section className="py-12 bg-base-100">
        <div className="container mx-auto px-4">
          <div className="prose max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-4">渋谷区でハウスクリーニングを依頼するなら？</h2>
            <p className="text-lg">渋谷区は東京23区の中心部に位置し、若者文化の発信地として知られています。商業施設が多く、高層マンションも増加しています。</p>
          </div>
        </div>
      </section>
