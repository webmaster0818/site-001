...
export const metadata = {
  title: "料金が安い業者ランキング | クリーンナビ",
  description: "コスパ最高のハウスクリーニング業者。実績、料金、口コミで徹底比較。",
};
    ...
    <div className="min-h-screen bg-base-100">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center mb-8">料金が安い業者ランキング</h1>
          <p className="text-xl text-center mb-12">コスパ最高のハウスクリーニング業者</p>
