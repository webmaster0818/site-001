...
export const metadata = {
  title: "カーペットクリーニング | クリーンナビ",
  description: "カーペットのシミ・ダニ・臭いを除去。料金相場、口コミ、おすすめ業者を比較。",
};
    ...
    <div className="min-h-screen bg-base-100">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">カーペットクリーニング</h1>
          <p className="text-xl mb-8">カーペットのシミ・ダニ・臭いを除去</p>
