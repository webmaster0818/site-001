...
export const metadata = {
  title: "ベランダクリーニング | クリーンナビ",
  description: "ベランダの汚れ・コケを高圧洗浄。料金相場、口コミ、おすすめ業者を比較。",
};

export default function BalconyService() {
  return (
    <div className="min-h-screen bg-base-100">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">ベランダクリーニング</h1>
          <p className="text-xl mb-8">ベランダの汚れ・コケを高圧洗浄</p>
