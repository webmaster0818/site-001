...
export const metadata = {
  title: "洗面所クリーニング | クリーンナビ",
  description: "洗面台・鏡の水垢を徹底清掃。料金相場、口コミ、おすすめ業者を比較。",
};

export default function WashroomService() {
  return (
    <div className="min-h-screen bg-base-100">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">洗面所クリーニング</h1>
          <p className="text-xl mb-8">洗面台・鏡の水垢を徹底清掃</p>
