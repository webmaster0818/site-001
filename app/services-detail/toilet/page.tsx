...
export const metadata = {
  title: "トイレクリーニング | クリーンナビ",
  description: "便器・床・壁の汚れを完全除去。料金相場、口コミ、おすすめ業者を比較。",
};

export default function ToiletService() {
  return (
    <div className="min-h-screen bg-base-100">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">トイレクリーニング</h1>
          <p className="text-xl mb-8">便器・床・壁の汚れを完全除去</p>
