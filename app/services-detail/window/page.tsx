...
export const metadata = {
  title: "窓・サッシクリーニング | クリーンナビ",
  description: "窓ガラス・網戸・サッシを完全清掃。料金相場、口コミ、おすすめ業者を比較。",
};
    ...
    <div className="min-h-screen bg-base-100">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">窓・サッシクリーニング</h1>
          <p className="text-xl mb-8">窓ガラス・網戸・サッシを完全清掃</p>
