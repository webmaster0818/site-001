...
export const metadata = {
  title: "洗濯機クリーニング | クリーンナビ",
  description: "洗濯槽のカビ・汚れを徹底除去。料金相場、口コミ、おすすめ業者を比較。",
};
    ...
    <div className="min-h-screen bg-base-100">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">洗濯機クリーニング</h1>
          <p className="text-xl mb-8">洗濯槽のカビ・汚れを徹底除去</p>
