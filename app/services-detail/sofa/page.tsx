...
export const metadata = {
  title: "ソファクリーニング | クリーンナビ",
  description: "ソファの汚れ・シミをプロが除去。料金相場、口コミ、おすすめ業者を比較。",
};

export default function SofaService() {
  return (
    <div className="min-h-screen bg-base-100">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">ソファクリーニング</h1>
          <p className="text-xl mb-8">ソファの汚れ・シミをプロが除去</p>
