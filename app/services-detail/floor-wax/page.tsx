...
export const metadata = {
  title: "フローリングワックス | クリーンナビ",
  description: "床の輝きを取り戻すワックスがけ。料金相場、口コミ、おすすめ業者を比較。",
};

export default function FloorwaxService() {
  return (
    <div className="min-h-screen bg-base-100">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">フローリングワックス</h1>
          <p className="text-xl mb-8">床の輝きを取り戻すワックスがけ</p>
