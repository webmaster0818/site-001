...
import { Wind, Bath, ChefHat } from "lucide-react";
...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        {/* 背景画像オーバーレイ */}
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-300/45 to-blue-300/55"></div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex gap-4 justify-center flex-wrap mb-12">
            <Link
              ...
              className="bg-yellow-400 text-gray-900 px-10 py-4 rounded-full font-bold text-lg hover:bg-yellow-500 transition shadow-xl"
            >
              業者を探す
            </Link>
            <Link
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <div className="bg-white/30 backdrop-blur-md rounded-lg px-6 py-4 border border-white/40">
              <div className="text-3xl md:text-4xl font-bold text-blue-800 mb-1 drop-shadow-lg">3,000<span className="text-xl">件+</span></div>
              <div className="text-white text-xs md:text-sm font-semibold">掲載業者数</div>
            </div>
            <div className="bg-white/30 backdrop-blur-md rounded-lg px-6 py-4 border border-white/40">
              <div className="text-3xl md:text-4xl font-bold text-blue-800 mb-1 drop-shadow-lg">47<span className="text-xl">都道府県</span></div>
              <div className="text-white text-xs md:text-sm font-semibold">対応エリア</div>
            </div>
            <div className="bg-white/30 backdrop-blur-md rounded-lg px-6 py-4 border border-white/40">
              <div className="text-3xl md:text-4xl font-bold text-blue-800 mb-1 drop-shadow-lg">98<span className="text-xl">%</span></div>
      ...
      <section className="py-16 bg-gradient-to-b from-white to-blue-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-12">
            <Link
              href="/services/aircon"
              className="inline-block bg-yellow-400 text-gray-900 px-10 py-4 rounded-full font-bold text-lg hover:bg-yellow-500 transition shadow-lg"
            >
              あなたに合った業者を探す
            </Link>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-500 to-blue-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link
            href="/services/aircon"
            className="inline-block bg-yellow-400 text-gray-900 px-12 py-5 rounded-full font-bold text-xl hover:bg-yellow-500 transition shadow-2xl"
          >
            今すぐ業者を探す
          </Link>
        </div>
