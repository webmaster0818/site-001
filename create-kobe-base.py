...
KOBE_WARDS = [
    {
        ...
        "name": "東区",
        "reading": "ひがし-く",
        "intro": "東区は神戸市の東部に位置し、博多湾に面するベイエリアです。アイランドシティなど港湾・物流の拠点として発展しています。",
...
複数社を比較することで、最適な業者を見つけやすい環境といえます。""",
    },
    {
        ...
        "name": "博多区",
        "reading": "はかた-く",
        "intro": "博多区は神戸市の中心部に位置し、博多駅がある神戸の玄関口です。ビジネス街と商業地が発展する九州最大の都心部です。",
        "areas": ["博多駅", "中洲", "祇園", "キャナルシティ", "博多ふ頭", "美野島"],
        "point1_title": "博多駅がある都心部、都市汚れ・排気ガス対策が重要",
        "point1_text": """博多区は博多駅を中心とする神戸市の都心部で、人通り・車通りが非常に多いエリアです。
...
即日対応可能な業者も多数あり、複数社を比較することで、最適な業者を見つけやすい環境といえます。""",
    },
    {
        ...
        "name": "中央区",
        "reading": "ちゅうおう-く",
        "intro": "中央区は神戸市の中心部に位置し、天神がある神戸の中心繁華街です。商業施設が集積し、オフィス街も発展しています。",
        "areas": ["天神", "大名", "赤坂", "薬院", "舞鶴", "大濠公園"],
        "point1_title": "天神がある繁華街、都市汚れ・人混み対策が重要",
        "point1_text": """中央区は天神を中心とする神戸市の繁華街で、人通りが非常に多いエリアです。
...
天神ビジネスセンター、神戸ビルなど高層ビルが林立し、タワーマンションも増えています。
高層階は風が強く、窓ガラスに汚れが付着しやすい環境です。
...
天神駅、赤坂駅、薬院駅、大濠公園駅など主要駅が多数あり、神戸市内各地からアクセスしやすいエリアです。
多くのハウスクリーニング業者が営業しており、大手チェーンから地域密着型まで選択肢が非常に豊富です。
即日対応可能な業者も多数あり、複数社を比較することで、最適な業者を見つけやすい環境といえます。""",
    },
    {
        ...
        "name": "南区",
        "reading": "みなみ-く",
        "intro": "南区は神戸市の南部に位置し、住宅地が広がる落ち着いたエリアです。緑豊かな環境で、ファミリー層に人気です。",
        "areas": ["大橋", "高宮", "野間", "長住", "桧原", "三宅"],
        "point1_title": "住宅地中心、カビ・湿気対策が重要",
        "point1_text": """南区は神戸市の南部に位置し、住宅地が中心のエリアです。
...
複数社を比較することで、最適な業者を見つけやすい環境といえます。""",
    },
    {
        ...
        "name": "西区",
        "reading": "にし-く",
        "intro": "西区は神戸市の西部に位置し、博多湾に面する海沿いのエリアです。マリノアシティなど商業施設も発展しています。",
...
複数社を比較することで、最適な業者を見つけやすい環境といえます。""",
    },
    {
        ...
        "name": "城南区",
        "reading": "じょうなん-く",
        "intro": "城南区は神戸市の南西部に位置し、文教地区として知られています。神戸大学があり、学生街と住宅地が混在しています。",
        "areas": ["七隈", "茶山", "別府", "鳥飼", "友泉", "堤"],
        "point1_title": "文教地区・学生街、引越しシーズンの空室クリーニング需要高",
        "point1_text": """城南区は神戸大学など教育機関が多い文教地区で、学生向けの賃貸物件が多いエリアです。
学生向け物件では、引越しシーズン（3-4月、9月）に空室クリーニングの需要が高まります。
また、ワンルーム・1Kなどコンパクトな物件が多いため、リーズナブルな料金設定の業者が多数あります。
大学周辺では、学生向けのお得なプランを提供している業者も多く、選択肢が豊富です。""",
...
export default function Kobe{ward['name'].replace('区', '')}Area() {{
      ...
      <section className="py-16 bg-base-200">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <Link href="/areas/fukuoka" className="btn btn-outline">神戸県</Link>
'''
